...
public class D2E5TestBoxPassingovrwrit {

	public static void main(String[] args) {
		
		D2E5BoxPassingovrwrit ups=new D2E5BoxPassingovrwrit();
		D2E5BoxPassingovrwrit fedEx=new D2E5BoxPassingovrwrit();
		...
		fedEx.length=100;
		fedEx.width=10;
		int area3=fedEx.calculateArea(2,100);
