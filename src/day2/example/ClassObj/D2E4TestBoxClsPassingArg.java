...
public class D2E4TestBoxClsPassingArg {

	public static void main(String[] args) {
		
		D2E4BoxClsPassingArg ups=new D2E4BoxClsPassingArg();
		D2E4BoxClsPassingArg fedEx=new D2E4BoxClsPassingArg();
		...
		fedEx.length=10;
		fedEx.width=10;
		int area2=fedEx.calculateArea(2);
